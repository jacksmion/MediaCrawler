...
BilibiliRequirementMode = Literal["search", "detail", "creator"]
KuaishouRequirementMode = Literal["search", "detail", "creator"]
TiebaRequirementMode = Literal["search", "detail", "creator"]
...
@dataclass(slots=True)
class BilibiliCrawlRequirement:
    """User-facing Bilibili crawl requirement model."""

    mode: BilibiliRequirementMode
    keywords: list[str] = field(default_factory=list)
...
@dataclass(slots=True)
class KuaishouCrawlRequirement:
    """User-facing Kuaishou crawl requirement model."""

    mode: KuaishouRequirementMode
    keywords: list[str] = field(default_factory=list)
    video_ids: list[str] = field(default_factory=list)
    creator_ids: list[str] = field(default_factory=list)
    start_page: int = 1
...
@dataclass(slots=True)
class TiebaCrawlRequirement:
    """User-facing Tieba crawl requirement model."""

    mode: TiebaRequirementMode
    keywords: list[str] = field(default_factory=list)
    note_ids: list[str] = field(default_factory=list)
    creator_urls: list[str] = field(default_factory=list)
    start_page: int = 1
