...
TIEBA_PLATFORM_RUNNER_MODE = "legacy"

ENABLE_TIEBA_CONNECTOR_SEARCH = False
ENABLE_TIEBA_CONNECTOR_DETAIL = False
ENABLE_TIEBA_CONNECTOR_COMMENTS = False
ENABLE_TIEBA_CONNECTOR_CREATOR = False
